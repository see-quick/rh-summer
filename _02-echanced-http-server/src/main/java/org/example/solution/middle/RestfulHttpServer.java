package org.example.solution.middle;
...
public class RestfulHttpServer {
    ...
    // ------------------------------------------------------
    // TODO: 4. Simulating a simple database with ? data structure
    //      hint: <id, name-of-the-item>
    // ------------------------------------------------------
    ...
    private void startServer() throws IOException {
        try (ServerSocket serverSocket = new ServerSocket(PORT)) {
            ...
            // ------------------------------------------------------
            // TODO: 5. What construct here needs to be to simulate server listening for client requests?
    ...
    /**
     * Handles the GET request for retrieving items.
     * This method is invoked to process incoming GET requests aimed at fetching items.
     * It constructs a JSON string representing all items and sends it back as a response.
     *
     * Example output: {"item1": "Apple", "item2": "Banana", "item3": "Cherry"}
     *
     * @param request The HttpRequest object representing the client's request.
     * @param writer  The BufferedWriter used to write the response back to the client.
     */
    private void handleGetItems(HttpRequest request, BufferedWriter writer) {
        System.out.println("GET items method invoked");

        // ------------------------------------------------------
        // TODO: 3. add get items response here :)
        String itemsJson = "";
        // ------------------------------------------------------
    ...
    private void handleGetItem(HttpRequest request, BufferedWriter writer) {
        ...
        try {
            ...
            if (item != null) {
                ...
                writeResponse(writer, body, "HTTP/1.1 " + statusCode + " OK\r\nContent-Type: " + contentType + "\r\n");
            } else {
                notFoundHandler(writer);
            }
    ...
    private void handlePostItem(HttpRequest request, BufferedWriter writer) {
        ...
        // ------------------------------------------------------
        // TODO: 6. Simulate creating an item
        //      don't forget to update some important value ! :)
        // ------------------------------------------------------
        //
    ...
    private void handleDeleteItem(HttpRequest request, BufferedWriter writer) {
        ...
        try {
            // ------------------------------------------------------
            // TODO: 7. Get specific id to be deleted (i.e., use auxiliary class HttpRequest to get such number :))
            // ------------------------------------------------------
