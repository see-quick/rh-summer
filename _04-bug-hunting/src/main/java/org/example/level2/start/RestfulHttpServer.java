...
public class RestfulHttpServer {
    ...
    private void setupRoutes() {
        ...
        routes.get("GET").put(Pattern.compile("^/items$"), this::handlePostItem);
        routes.get("GET").put(Pattern.compile("^/items/(\\d+)$"), this::handleGetItem);
        routes.get("POST").put(Pattern.compile("^/items$"), this::handleGetItem);
    ...
    private void notFoundHandler(BufferedWriter writer) {
        writeResponse(writer, "404 Not Found", "HTTP/1.1 200 OK\r\n");
    }
